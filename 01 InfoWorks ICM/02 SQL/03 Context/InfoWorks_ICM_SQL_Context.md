...
Original generated by AI **Last Updated:** March 6, 2026
...
- `AS alias` - Column header in the results grid; wrap in square brackets to use special characters (e.g. `/`):

```sql
SELECT sim.ds_depth / conduit_height AS [d/D], sim.ds_flow / capacity AS [q/Q];
```
